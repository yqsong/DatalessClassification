...
public class CorpusWordDistProcessingRCV {
...
//		}
	...
	public static void conceptualizeRCVTrain (int num, String methodStr) 	{
		...
		CorpusWordDistProcessingRCV corpusContentProc = new CorpusWordDistProcessingRCV();
...
//		ngData.readCorpusContentOnly(inputIndexDir, random, trainingRate);
		...
		if (methodStr.equals("brownClusterWikiOld")) {
			...
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_train/rcv_train.word.dist.features.browncluster.enwiki.old" + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_train/rcv_train.word.dist.features.browncluster.enwiki.old" + num;
			}
		}
		if (methodStr.equals("brownClusterWiki")) {
			method = "browncluster" + num + "";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_train/rcv_train.word.dist.features.browncluster.enwiki." + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_train/rcv_train.word.dist.features.browncluster.enwiki." + num;
			}
		}
		...
		if (methodStr.equals("brownCluster20NGOld")) {
			...
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_train/rcv_train.word.dist.features.browncluster.20NG.old" + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_train/rcv_train.word.dist.features.browncluster.20NG.old" + num;
			}
		}
		if (methodStr.equals("brownCluster20NG")) {
			method = "browncluster" + num + "_20NG";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_train/rcv_train.word.dist.features.browncluster.20NG." + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_train/rcv_train.word.dist.features.browncluster.20NG." + num;
			}
		}
		...
		if (methodStr.equals("brownClusterRatinovOld")) {
			...
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_train/rcv_train.word.dist.features.browncluster.ratinov.old" + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_train/rcv_train.word.dist.features.browncluster.ratinov.old" + num;
			}
		}
		if (methodStr.equals("brownClusterRatinov")) {
			method = "browncluster" + num + "_Ratinov";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_train/rcv_train.word.dist.features.browncluster.ratinov." + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_train/rcv_train.word.dist.features.browncluster.ratinov." + num;
			}
		}
		...
		if (methodStr.equals("ratinovEmbedding")) {
			...
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_train/rcv_train.word.dist.features.ratinov.embedding." + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_train/rcv_train.word.dist.features.ratinov.embedding." + num;
			}
		}
		////////////////////////////////////////////////////////////
		if (methodStr.equals("word2vector")) {
			...
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_train/rcv_train.word.dist.features.enwiki.vivek." + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_train/rcv_train.word.dist.features.enwiki.vivek." + num;
			}
		}
		////////////////////////////////////////////////////////////
		if (methodStr.equals("senna")) {
			method = "senna";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_train/rcv_train.word.dist.features.enwiki.senna";
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_train/rcv_train.word.dist.features.enwiki.senna";
			}
		}
		////////////////////////////////////////////////////////////
...
//		ngData.readCorpusContentOnly(inputIndexDir, random, trainingRate);
		...
		if (methodStr.equals("brownClusterWikiOld")) {
			method = "browncluster" + num + "_old";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_test/rcv_test_pt" + partNum + ".word.dist.features.enwiki.browncluster.old" + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_test/rcv_test_pt" + partNum + ".word.dist.features.enwiki.browncluster.old" + num;
			}
		}
		if (methodStr.equals("brownClusterWiki")) {
			method = "browncluster" + num + "";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_test/rcv_test_pt" + partNum + ".word.dist.features.enwiki.browncluster" + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_test/rcv_test_pt" + partNum + ".word.dist.features.enwiki.browncluster" + num;
			}
		}
		...
		if (methodStr.equals("brownCluster20NGOld")) {
			method = "browncluster" + num + "_old_20NG";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_test/rcv_test_pt" + partNum + ".word.dist.features.20NG.browncluster.old" + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_test/rcv_test_pt" + partNum + ".word.dist.features.20NG.browncluster.old" + num;
			}
		}
		if (methodStr.equals("brownCluster20NG")) {
			method = "browncluster" + num + "_20NG";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_test/rcv_test_pt" + partNum + ".word.dist.features.20NG.browncluster" + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_test/rcv_test_pt" + partNum + ".word.dist.features.20NG.browncluster" + num;
			}
		}
		...
		if (methodStr.equals("brownClusterRatinovOld")) {
			method = "browncluster" + num + "_old_Ratinov";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_test/rcv_test_pt" + partNum + ".word.dist.features.ratinov.browncluster.old" + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_test/rcv_test_pt" + partNum + ".word.dist.features.20NG.browncluster.old" + num;
			}
		}
		if (methodStr.equals("brownClusterRatinov")) {
			method = "browncluster" + num + "_Ratinov";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_test/rcv_test_pt" + partNum + ".word.dist.features.ratinov.browncluster" + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_test/rcv_test_pt" + partNum + ".word.dist.features.20NG.browncluster" + num;
			}
		}
		...
		if (methodStr.equals("ratinovEmbedding")) {
			method = "ratinovEmbedding" + num;
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_test/rcv_test_pt" + partNum + ".word.dist.features.ratinov.embedding." + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_test/rcv_test_pt" + partNum + ".word.dist.features.ratinov.embedding." + num;
			}
		}
		////////////////////////////////////////////////////////////
		if (methodStr.equals("word2vector")) {
			method = "word2vector" + num;
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_test/rcv_test_pt" + partNum + ".word.dist.features.enwiki.vivek." + num;
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_test/rcv_test_pt" + partNum + ".word.dist.features.enwiki.vivek." + num;
			}
		}
		////////////////////////////////////////////////////////////
		if (methodStr.equals("senna")) {
			method = "senna";
			if (ClassifierConstant.isServer == false) {
				outputFile = "D:/yqsong/data/rcv/output_test/rcv_test_pt" + partNum + ".word.dist.features.enwiki.senna";
			} else {
				outputFile = "/shared/shelley/yqsong/benchmark/rcv1v2/output_test/rcv_test_pt" + partNum + ".word.dist.features.enwiki.senna";
			}
		}
		////////////////////////////////////////////////////////////
