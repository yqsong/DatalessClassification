...
//	  if (l != null) {
//			System.out.println("    [Debug Training:] Labler containingPackage: " + l.containingPackage + 
//					", name: " + l.name + 
//					", getInputType(): " + l.getInputType() + 
//					", getOutputType(): " + l.getOutputType() 
//					);
//		}
